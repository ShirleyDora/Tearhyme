(function ($)
{
    ...
    function toArray(strg)
    {
        ...
        return [parseFloat(res[1], 10), res[2], parseFloat(res[3], 10), res[3],parseFloat(res[4],10),res[4],parseFloat(res[5],10),res[5],parseFloat(res[6],10),res[6]];
    }
